 ...
 * defined below does not have a default no-args constructor.</p>
 *
 * <pre>
 * public class Id&lt;T&gt; {
 ...
 * solve this problem by defining an {@code InstanceCreator} for {@code Id}:</p>
 *
 * <pre>
 ...
 * developer will need to register {@code IdInstanceCreator} with Gson as follows:</p>
 *
 * <pre>
...
public interface InstanceCreator<T> {
       ...
       * return an instance that is useful elsewhere. In particular, do not return a common
