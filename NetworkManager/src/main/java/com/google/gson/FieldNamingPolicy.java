...
public enum FieldNamingPolicy implements FieldNamingStrategy {
      ...
      /**
       * Using this naming policy with Gson will ensure that the first "letter" of the Java field
       * name is capitalized when serialized to its JSON form.
       *
       * <p>
       * Here's a few examples of the form "Java Field Name" ---> "JSON Field Name":</p>
       * <ul>
      ...
      /**
       * Using this naming policy with Gson will ensure that the first "letter" of the Java field
       * name is capitalized when serialized to its JSON form and the words will be separated by a
       * space.
       *
       * <p>
       * Here's a few examples of the form "Java Field Name" ---> "JSON Field Name":</p>
