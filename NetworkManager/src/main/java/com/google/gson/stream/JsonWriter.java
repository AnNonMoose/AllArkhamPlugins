...
public class JsonWriter implements Closeable, Flushable {
       ...
       * well-formed JSON as specified by <a href="http://www.ietf.org/rfc/rfc4627.txt">RFC
       * 4627</a>. Setting the writer to lenient permits the following:
       * <ul>
       ...
       * documents. This escapes the HTML characters {@code <}, {@code >},
       * {@code &} and {@code =} before writing them to the stream. Without this setting, your
       * XML/HTML encoder should replace these characters with the corresponding escape sequences.
       */
      ...
      /**
       * Returns true if this writer writes JSON that's safe for inclusion in HTML and XML
       * documents.
       */
      ...
      /**
       * Returns true if object members are serialized when their value is null. This has no impact
       ...
       * inline object. Also adjusts the stack to expect either a closing bracket or another
       * element.
       *
       * @param root true if the value is a new array or object, the two values permitted as
       * top-level elements.
       */
