...
public class TypeToken<T> {
    ...
    // No generic defined on "to"; therefore, return true and let other
      ...
      /**
       * Checks if two parameterized types are exactly equal, under the variable replacement
       * described in the typeVarMap.
       */
      ...
      /**
       * Checks if two types are the same or are equivalent under a variable mapping given in the
       * type map that was provided.
       */
