 ...
 * this deserializer through {@link GsonBuilder#registerTypeAdapter(Type, Object)}.</p>
 *
 * <p>
 * Let us look at example where defining a deserializer will be useful. The {@code Id} class defined
 * below has two fields: {@code clazz} and {@code value}.</p>
 *
 * <pre>
 * public class Id&lt;T&gt; {
 ...
 *
 * <p>
 * You will also need to register {@code IdDeserializer} with Gson as follows:</p>
 *
 * <pre>
...
public interface JsonDeserializer<T> {
       ...
       * the the same type passing {@code json} since that will cause an infinite loop (Gson will
       * call your call-back method again).
       *
       * @param json The Json data being deserialized
       * @param typeOfT The type of the Object to deserialize to
       * @return a deserialized object of the specified type typeOfT which is a subclass of
       * {@code T}
