...
public interface JsonSerializationContext {
      ...
      /**
       * Invokes default serialization on the specified object passing the specific type
       * information. It should never be invoked on the element received as a parameter of the
