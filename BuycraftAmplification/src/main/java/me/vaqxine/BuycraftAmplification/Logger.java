...
public class Logger {
	...
	public void notice(String s, Class<?> c){
		System.out.println(ansi_green + "[BuycraftAmplification (" + c.getSimpleName() + ")] " + s + ansi_reset);
	}
	
	public void debug(String s, Class<?> c){
		System.out.println(ansi_yellow + "(DE) " + ansi_reset + "[BuycraftAmplification (" + c.getSimpleName() + ")] " + s + ansi_reset);
	}
	
	public void log(String s, Class<?> c){
		System.out.println("[BuycraftAmplification (" + c.getSimpleName() + ")] " + s);
	}
	
	public void warning(String s, Class<?> c){
		System.out.println(ansi_yellow + "[BuycraftAmplification (" + c.getSimpleName() + ")] " + s + ansi_reset);
	}
	
	public void error(String s, Class<?> c){
		System.out.println(ansi_red + "[BuycraftAmplification(" + c.getSimpleName() + ")] " + s + ansi_reset);
	}
}
