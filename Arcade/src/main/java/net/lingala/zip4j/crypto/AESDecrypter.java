...
public class AESDecrypter implements IDecrypter {
    ...
    public AESDecrypter(LocalFileHeader localFileHeader, byte[] salt,
    ...
    private void init(byte[] salt, byte[] passwordVerifier) throws ZipException {
        if (localFileHeader == null) {
            throw new ZipException(
                    "invalid file header in init method of AESDecryptor");
        }
        ...
        if (aesExtraDataRecord == null) {
            throw new ZipException(
                    "invalid aes extra data record - in init method of AESDecryptor");
        }
        ...
        switch (aesExtraDataRecord.getAesStrength()) {
            ...
            case Zip4jConstants.AES_STRENGTH_256:
                ...
                break;
            default:
                throw new ZipException("invalid aes key strength for file: "
        ...
        if (localFileHeader.getPassword() == null
            ...
            throw new ZipException(
                    "empty or null password provided for AES Decryptor");
        }
        ...
        System.arraycopy(derivedKey, KEY_LENGTH + MAC_LENGTH,
        ...
        if (!Arrays.equals(passwordVerifier, derivedPasswordVerifier)) {
            throw new ZipException("Wrong Password for file: "
                    + localFileHeader.getFileName(),
